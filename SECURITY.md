...
- v1.0.61 **(Current Version)**
- v1.0.60 **(Previous Major Version)**

> [!IMPORTANT]
> Versions before **v1.0.60** are no longer supported and may contain unaddressed vulnerabilities. We strongly recommend upgrading to a supported version to ensure continued security.
