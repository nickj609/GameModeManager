...
- v1.0.54 **(Current Version)**
- v1.0.53 **(Previous Major Version)**

> [!IMPORTANT]
> Versions before **v1.0.53** are no longer supported and may contain unaddressed vulnerabilities. We strongly recommend upgrading to a supported version to ensure continued security.
