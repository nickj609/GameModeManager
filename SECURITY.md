...
- v1.0.55 **(Current Version)**
- v1.0.54 **(Previous Major Version)**

> [!IMPORTANT]
> Versions before **v1.0.54** are no longer supported and may contain unaddressed vulnerabilities. We strongly recommend upgrading to a supported version to ensure continued security.
