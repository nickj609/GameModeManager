...
- v1.0.64 **(Current Version)**
- v1.0.63 **(Previous Major Version)**

> [!IMPORTANT]
> Versions before **v1.0.63** are no longer supported and may contain unaddressed vulnerabilities. We strongly recommend upgrading to a supported version to ensure continued security.
