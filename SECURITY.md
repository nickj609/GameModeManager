...
- v1.0.69 **(Current Version)**
- v1.0.68 **(Previous Major Version)**

> [!IMPORTANT]
> Versions before **v1.0.68** are no longer supported and may contain unaddressed vulnerabilities. We strongly recommend upgrading to a supported version to ensure continued security.
