...
- v1.0.80 **(Current Version)**
- v1.0.79 **(Previous Major Version)**

> [!IMPORTANT]
> Versions before **v1.0.79** are no longer supported and may contain unaddressed vulnerabilities. We strongly recommend upgrading to a supported version to ensure continued security.
